...
def open_report():
    report = filedialog.askopenfilename(initialdir="/Users/mayankraj/PycharmProjects/Hospital_management_system",
...
work_page = tk.Text(master=report_frame, width=75, height=20)
